{{-- <div class="">
    ...
    <div
        class="sidebar fixed top-0 bottom-0  w-64 bg-gray-900 shadow z-30 overflow-y-auto text-center px-2.5 ">
        <div class="text-gray-100 text-xl">
            ...
            <div class="p-2.5 mt-1 flex items-center ">
                ...
                <i class="bi bi-x ml-20 text-2xl cursor-pointer lg:hidden"></i>
            </div>
            <hr class="text-gray-600 my-2">
        </div>
        <div class="flex flex-col justify-between ">
            <div class="flex flex-column  ">
                <div class="px-2.5  flex items-center rounded-md duration-300 cursor-pointer bg-gray-700 text-white">
                    <i class="bi bi-search text-sm"></i>
                    <input type="text" placeholder="Search"
                        class="text-[15px] ml-4 w-full bg-transparent  focus:outline-none border-none text-gray-100">
                </div>

                <div
                    class="p-2.5 mt-3 flex items-center text-white  rounded-md  cursor-pointer transition-all duration-300  hover:bg-slate-500 hover:text-red-700 ">
                    <a href="/" class=""><i class="bi bi-house-door-fill text-sm"></i>
                        <span class="text-[15px] ml-4 text-gray-300 ">Home</span></a>
                </div>
                

                <div
                    class="p-2.5 mt-3 flex items-center text-white  rounded-md  cursor-pointer transition-all duration-300  hover:bg-slate-500 hover:text-red-700 ">
                    <a href="/loan-application" class="">
                        <i class="bi bi-pencil-fill text-sm"></i>
                        <span class="text-[15px] ml-4 text-gray-300 ">Apply Loan</span></a>
                </div>

                @can('isAdmin')
                    <div
                        class="p-2.5 mt-3 flex items-center text-white  rounded-md  cursor-pointer transition-all duration-300  hover:bg-slate-500 hover:text-red-700 ">
                        <a href="/pending-loans" class="">

                            <i class="bi bi-hourglass-split text-sm"></i>
                            <span class="text-[15px] ml-4 text-gray-300 ">Pending Loans</span>
                        </a>
                    </div>
                    <div
                        class="p-2.5 mt-3 flex items-center text-white  rounded-md  cursor-pointer transition-all duration-300  hover:bg-slate-500 hover:text-red-700 ">
                        <a href="/loans-ongoing" class="">
                            <i class="bi bi-file-earmark-text-fill text-sm"></i>
                            <span class="text-[15px] ml-4 text-gray-300 ">Ongoing Loans</span>
                        </a>
                    </div>

                    <div
                        class="p-2.5 mt-3 flex items-center text-white  rounded-md  cursor-pointer transition-all duration-300  hover:bg-slate-500 hover:text-red-700 ">
                        <a href="/repayment-alerts" class="">
                            <i class="bi bi-chat-dots-fill text-sm"></i>
                            <span class="text-[15px] ml-4 text-gray-300 ">Loan Repayment</span>
                        </a>
                    </div>
                    ...
                    <div
                        ...
                        <a href="/users" class="">
                            ...
                            <span class="text-[15px] ml-4 text-gray-300 ">Users</span>
                        </a>
                    </div>
                    ...
                    <div
                        ...
                        <a href="/reports" class="">
                            ...
                            <span class="text-[15px] ml-4 text-gray-300 ">Reports</span>
                        </a>
                    </div>
                    <hr class="text-gray-600 my-2">
                @endcan
            ...
            <div
                class="p-2.5 mt-4 flex items-center text-white  rounded-md  cursor-pointer transition-all duration-300  hover:bg-slate-500 hover:text-red-700 ">
